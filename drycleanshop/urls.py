...
urlpatterns = [
    ...
    path('customer/new/',customers.views.CustomerCreateView.as_view()),
    path('edit-customer/<int:pk>/',customers.views.EditCustomerView.as_view()),
    path('order/',orders.views.OrderView.as_view()),
    path('order/<int:pk>/order-items/',orders.views.OrderItemView.as_view()),
    path('order/<int:pk>/new-order-item/',orders.views.OrderItemCreateView.as_view()),
    path('order/<int:pk>/edit-order-item/',orders.views.EditOrderItemView.as_view()),
    path('employees/',employees.views.EmployeeView.as_view()),
    path('employees/new/',employees.views.EmployeeCreateView.as_view()),
